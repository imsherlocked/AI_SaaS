...
const SideBar=()=>{
    return(
        <div className="space-y-4 flex flex-col h-full bg-navy-700 text-white">
            <div className="px-3 py-2 flex-1">
                <Link href={"/dashboard"} className="flex items-center pl-3 mb-14">
                <div className="relative 2-8 h-8 mr-4">
                <Image fill alt="logo" src="/logo.png" />
                </div>
                <h1 className={cn("text-2xl", monserrat.className)}><b>Genius</b></h1>
